...
class ImageHelper
{
	 ...
	 * @copyright (c) 2013, bb
	 */
	static public function createNoImage($width, $height, $aBackgroundRGB = array(255, 255, 255), $aTextRGB = array(0, 0, 0))
	{
	...
	/**
		 ...
		 * bb
		 */
		static public function createFullImage($source_folder, $source_filename, $final_width, $final_height, $destination_folder = NULL, $aRGB = array(255, 255, 255)) 
		{
...
//            $black = @imagecolorallocate($bg_image, 0, 0, 0);
	 ...
	 * @author bb
	 */
	static public function createDirectoryByPath($path)
	{
	...
	//bb
	static public function removeEmptyItemFromArray(&$arr)
	{
	...
	/** 
	  ...
	  */
	 static public function getImageUrl($path, $width = NULL, $height = NULL)
	 {
		 if($width && $height)
			$noimagePath = 'upload/noimage/'.$width.'x'.$height.'.jpg';
		 else
