<div class="portlet mt-4" id="yw0">
    ...
    <div class="portlet-content">
        <div id="location-grid" class="grid-view p-2">
            <form method="POST" action='<?php echo Yii::app()->baseUrl."/index.php?r=users/save";  ?>' class="row">
                <div class="col-md-6">
                    <div class="form-group">
                        <label for="grid-name">Name</label>
                        <input name="name" id="grid-name" 
                ...
                <div class="col-md-6">
                    <div class="form-group">
                        ...
                        <input name="email" id="grid-email" 
                ...
                <div class="col-md-6">
                    <div class="form-group">
                        ...
                        <input name="username" 
                            value="<?php echo $data ? $data['username'] : '' ?>"
                            id="grid-username" class="form-control" type="text">
                    </div>
                </div>
                <div class="col-md-6">
                    <div class="form-group">
                        ...
                        <input name="phone" 
                            ...
                            id="grid-phone" class="form-control" type="text">
                    </div>
                </div>
                <div class="col-md-6">
                    <div class="form-group">
