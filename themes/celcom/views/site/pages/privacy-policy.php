<?php
Yii::app()->name = 'Privacy Policy Celcom Africa LTD';
Yii::app()->clientScript->registerMetaTag('Privacy Policy Cheap Bulk SMS in Kenya', 'description');
Yii::app()->clientScript->registerMetaTag('', 'keywords');
$canon = Yii::app()->createAbsoluteUrl('site/page', array('view' => 'privacy-policy'));
Yii::app()->clientScript->registerLinkTag('canonical', null, $canon);
?>

<div class="container py-5">
    <div class="row px-2" style="color: #000; font-size:16px;">
        <h3 class="pb-2">Our Privacy Policy</h3>
        <p>This privacy policy sets out how Celcom Afica Ltd uses and protects any information that you give Celcom
            Afica Ltd when you use this website.</p>
        <p>
            Celcom Afica Ltd is committed to ensuring that your privacy is protected. Should we ask you to provide
            ...
            Celcom Afica Ltd may change this policy from time to time by updating this page. You should check this page
            from time to time to ensure that you are happy with any changes. This policy is effective from Monday, 1st
            October 2013.
        </p>
        ...
        <div>
            <ol>
                ...
                <li>From time to time, we may also use your information to contact you for market research purposes. We
                    may
                    contact you by email, phone, fax or mail. We may use the information to customise the website
                    according
                    to your interests.
                </li>
            </ol>
        ...
        <div>
            <ol>
                ...
                <li>If you have previously agreed to us using your personal information for direct marketing purposes,
                    you
                    may change your mind at any time by writing to or emailing us at sms@celcomafrica.com
                </li>
            </ol>
        </div>
        <br>
        ...
        <p> You may request details of personal information which we hold about you. A small fee may be payable. If you
            would like a copy of the information held on you please write to sms@celcomafrica.com
        </p>
    </div>
</div>